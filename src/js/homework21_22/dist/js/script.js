        ...
        var b,
            ...
            var c = b.length > 0,
                ...
                var l,
                    ...
                    }G.apply(i, u), k && !_f2 && u.length > 0 && r + b.length > 1 && ga.uniqueSort(i);
                }return k && (w = y, j = v), t;
            };return c ? ia(f) : f;
...
var testModule = {
    getSampleQuestionsAndAnswers: function getSampleQuestionsAndAnswers() {
        return {
            title: 'Programming test',
            questions: [{
                title: 'Which languages have strict types?',
                answers: [{ id: 11, text: 'Javascript' }, { id: 12, text: 'Java', correct: true }, { id: 13, text: 'Python' }, { id: 14, text: 'C++', correct: true }]
            }, {
                title: 'Which types do not exist in Javascript?',
                answers: [{ id: 21, text: 'short', correct: true }, { id: 22, text: 'integer' }, { id: 23, text: 'boolean' }, { id: 24, text: 'undefined' }]
            }, {
                title: 'Which of the tags existed before HTML5 specification?',
                answers: [{ id: 31, text: 'header' }, { id: 32, text: 'footer' }, { id: 33, text: 'aside' }, { id: 34, text: 'div', correct: true }]
            }],
            submitTitle: 'Test my results'
        };
    },

    getHeader: function getHeader(questionsAndAnswers) {
        var headerTemplate = _.template(document.getElementById('header_template').innerHTML);
        return headerTemplate(questionsAndAnswers);
    },

    getQuestions: function getQuestions(questionsAndAnswers) {
    ...
    getSubmit: function getSubmit(questionsAndAnswers) {
...
$(function () {
    ...
    var questionsAndAnswers = testModule.getSampleQuestionsAndAnswers();
    var header = testModule.getHeader(questionsAndAnswers);
    var questions = testModule.getQuestions(questionsAndAnswers);
    var submit = testModule.getSubmit(questionsAndAnswers);
    ...
    $submitButton.on('click', function () {
        var maxResult = questionsAndAnswers.questions.length;
        var userResult = 0;
